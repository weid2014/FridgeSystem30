...
import com.jhteck.icebox.face.FaceRepository;
import com.jhteck.icebox.face.FaceServer;
import com.jhteck.icebox.face.callback.BatchRegisterCallback;
import com.jhteck.icebox.face.callback.OnRegisterFinishedCallback;
import com.jhteck.icebox.face.facedb.FaceDatabase;
import com.jhteck.icebox.face.facedb.dao.FaceDao;
import com.jhteck.icebox.face.facedb.entity.FaceEntity;
import com.jhteck.icebox.face.util.FileUtil;
...
public class FacePhotoViewModel extends ViewModel {
    ...
    public FacePhotoViewModel() {
        faceDao = FaceDatabase.getInstance(BaseApp.app).faceDao();
    }
    ...
    public void init() {
        if (faceRepository == null) {
            ...
            instance.init(BaseApp.app.getApplicationContext(), faceCount -> initFinished.postValue(true));
